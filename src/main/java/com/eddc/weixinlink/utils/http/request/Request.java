package com.eddc.weixinlink.utils.http.request;

import com.eddc.weixinlink.utils.http.exception.MethodNotSupportException;
...
public class Request {
    ...
    protected void checkMethod(RequestMethod method) throws MethodNotSupportException, MethodNotSupportException {
        if (null == method) {
